...
def create_manuscript(title: str, author: str, author_email: str, referee: str, state: str, text: str) -> str:
...
def update(id: str, title: str, author: str, author_email: str, referee: str, state: str, text: str) -> str:
    """ 
